      ...
      var sampleListings = [
        {
          ...
          agent: 'Jennifer Walsh', status: 'active',
        ...
        },
        {
          ...
          agent: 'Marcus Rivera', status: 'active',
        ...
        },
        {
          ...
          agent: 'Sarah Chen', status: 'active',
        ...
        },
        {
          ...
          agent: 'Marcus Rivera', status: 'pending',
