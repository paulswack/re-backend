  ...
  if (!Auth.isPrivileged()) {
    document.getElementById('pageBody').innerHTML =
      '<div class="empty-state" style="padding:80px 40px;text-align:center">' +
        ...
        '<a href="dashboard.html" style="display:inline-block;margin-top:16px;padding:10px 24px;border-radius:8px;background:var(--indigo);color:#fff;font-weight:600;font-size:.85rem;text-decoration:none">Back to Dashboard</a>' +
      '</div>';
    return;
  }
