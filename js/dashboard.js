...
(function () {
  ...
  function renderDashboard() {
    ...
    // CUSTOMIZE BAR (Team Lead / Admin only)
    if (isLead) {
      h += '<div class="dash-customize-bar">' +
        '<div></div>' +
        '<div style="display:flex;gap:8px;align-items:center">' +
          '<button class="btn-reset" data-action="reset-layout" title="Reset to default layout"><svg viewBox="0 0 24 24" width="12" height="12" fill="currentColor"><path d="M17.65 6.35C16.2 4.9 14.21 4 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08c-.82 2.33-3.04 4-5.65 4-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35z"/></svg> Reset</button>' +
          '<button class="btn-customize" data-action="toggle-edit-mode"><svg viewBox="0 0 24 24"><path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/></svg> Customize</button>' +
        '</div>' +
      '</div>';
    }
